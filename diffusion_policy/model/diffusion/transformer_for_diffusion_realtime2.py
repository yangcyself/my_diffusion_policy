...
# the transformer for diffusion without time embedding
class TransformerForDiffusion_realtime2(ModuleAttrMixin):
    def __init__(self,
            input_dim: int,
            output_dim: int,
            horizon: int,
    ...
    def _init_weights(self, module):
        ...
        elif isinstance(module, TransformerForDiffusion_realtime2):
...
def test():
    ...
    transformer = TransformerForDiffusion_realtime2(
        input_dim=16,
        output_dim=16,
        horizon=8,
        n_obs_steps=4,
